...
public abstract class RepositoryDB<T extends Entity> implements IRepository<T> {
    ...
    public RepositoryDB(Context context)
    {
        ...
        dbHelper = DBHelperRepository.Get(this.context, GetTableName(), null, GetTableVersion(), GetTableCreateQuery(), GetTableUpdateQuery());
        entityFactory = GetEntityFactoryBuilder().GetFactory(GetTableName());
    }
    ...
    protected abstract IEntityFactoryBuilder GetEntityFactoryBuilder();
